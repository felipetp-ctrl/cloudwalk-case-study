...
def test_ip_exact_match_within_window():
    requests = pd.DataFrame(
        {
            ...
            "timestamp": pd.to_datetime(
                ["2025-01-07T04:00:00+00:00", "2025-01-07T08:00:00+00:00"]
            ),
    ...
    assert result.loc[result.request_id == "r1", "is_malicious"].iloc[0] == True  # noqa: E712
    assert result.loc[result.request_id == "r2", "is_malicious"].iloc[0] == False  # noqa: E712
...
def test_tls_fingerprint_match():
    ...
    result = join_labels(requests, labels)
    assert result.loc[0, "is_malicious"] == True  # noqa: E712
...
def test_no_labels_all_benign():
    ...
    result = join_labels(requests, labels)
    assert result.loc[0, "is_malicious"] == False  # noqa: E712
